...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($tempname, $folder) and move_uploaded_file($tempname2,$folder2)) {
        //renaming the files
        ...
        $movieInfoQuery ="INSERT INTO `movie_info` VALUES('$finalMovieID','$movieThumb','$movieBack','$description','$price')";
